...
- (void)setCoinStyle
{
    ...
    [_coinView mas_makeConstraints:^(MASConstraintMaker *make) {
        make.width.equalTo(self.mas_width).multipliedBy(0.3441);
        make.height.equalTo(self.mas_height).multipliedBy(0.15);
        make.left.equalTo(self.mas_right).multipliedBy(0.2744);
        make.bottom.equalTo(self.mas_bottom).multipliedBy(1 - 0.20625);
...
- (void)setBasicCoupon
{
    ...
    [_coupondDiscountLable mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.left.equalTo(self.mas_right).multipliedBy(0.13553);
        make.top.equalTo(self.mas_bottom).multipliedBy(0.30625);
    }];
    ...
    [_couponTypeDescribeLable mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.top.equalTo(_coupondDiscountLable.mas_bottom);
    ...
    [_shopIcon mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.width.equalTo(self.mas_width).multipliedBy(0.18605);
        make.right.equalTo(self.mas_right).multipliedBy(0.8);
        make.top.equalTo(self.mas_bottom).multipliedBy(0.2875);
    }];
    ...
    [_couponShopLable mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.top.equalTo(_shopIcon.mas_bottom).offset(4);
...
- (void)setToyStyle
{
    ...
    [_toys mas_makeConstraints:^(MASConstraintMaker *make) {
        make.height.equalTo(self.mas_height).multipliedBy(0.625);
        make.width.equalTo(self.mas_width).multipliedBy(0.46512);
        make.top.equalTo(self.mas_bottom).multipliedBy(0.05625);
        make.left.equalTo(self.mas_right).multipliedBy(0.22791);
    }];
...
- (void)setEXPStyle
{
    ...
    [self.expLable mas_makeConstraints:^(MASConstraintMaker *make) {
        make.height.equalTo(self.mas_height).multipliedBy(0.52500);
        make.width.equalTo(self.mas_width).multipliedBy(0.41395);
        make.top.equalTo(self.mas_bottom).multipliedBy(0.3625);
        make.left.equalTo(self.mas_right).multipliedBy(0.25581);
    }];
...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        [self.CoinNumberLable mas_makeConstraints:^(MASConstraintMaker *make) {
            make.left.equalTo(self.coinIcon.mas_right);
